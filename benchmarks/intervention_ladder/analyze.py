...
The sweep itself is driven from the sibling ``agent-harness-from-scratch``
repo -- that is where the 100-tool kit, the agent, the task generator and the
condition definitions live. This repo owns the *measurement*: per-task
aggregation, bootstrap intervals and paired significance testing via
``agent_eval.stats``.
