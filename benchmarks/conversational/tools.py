"""Same small tool set as benchmarks/agent_trajectory/tools.py, duplicated

rather than imported so each benchmark stays independently runnable
without one depending on another's internal module layout.
"""
