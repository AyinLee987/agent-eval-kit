"""A small, self-contained tool set for the robustness benchmark.

Same tools/facts as benchmarks/agent_trajectory and benchmarks/conversational
(duplicated, not imported, so each benchmark folder stays self-contained —
see those folders for the same convention).
